...
function init() {
    ...
    //LOCAL PATCH, keep when re-vendoring (see #261): firmware 2.0.0 removed the global ble.enable
    //flag, so the upstream test !BLEConfig.enable aborted init() before Subscribe on 2.0.0+.
